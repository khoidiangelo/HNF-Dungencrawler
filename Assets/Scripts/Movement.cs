        ...
        if (movement.sqrMagnitude > 0)
        {
            if (Mathf.Abs(movement.x) > Mathf.Abs(movement.y))
            {
                if (movement.x > 0)
                {
                    ...
                    Sword.transform.position = new Vector3(0.085f,-0.017f,0f);
                ...
                {
                    Direction = new Vector2(-1f, 0f);
                    Sword.transform.position = new Vector3(-0.085f,-0.004f,0f);
            ...
            else 
            {
                ...
                { 
                    ...
                    Sword.transform.position = new Vector3(0.003f,-0.107f,0f);
                    Sword.gameObject.GetComponent<SpriteRenderer>().flipY = true;
                     Sword.gameObject.GetComponent<SpriteRenderer>().flipX = false;
                ...
                {
                    Direction = new Vector2(0f, -1f);
                    Sword.transform.position = new Vector3(0.013f,-0.125f,0f);
                    Sword.gameObject.GetComponent<SpriteRenderer>().flipY = true;
                    Sword.gameObject.GetComponent<SpriteRenderer>().flipX = false;
